...
class RTObject : public omg_rtc::RTObject
{
	...
	virtual omg_rtc::ReturnCode_t detach_context(omg_rtc::ExecutionContextHandle_t exec_handle) override;
	virtual omg_rtc::ExecutionContext *get_context(omg_rtc::ExecutionContextHandle_t exec_handle) override;
	...
	virtual omg_rtc::ExecutionContextHandle_t get_context_handle(omg_rtc::ExecutionContext& cxt) override;

	virtual omg_rtc::ReturnCode_t on_initialize() override;
	virtual omg_rtc::ReturnCode_t on_finalize() override;
	virtual omg_rtc::ReturnCode_t on_startup(omg_rtc::ExecutionContextHandle_t exec_context) override;
	virtual omg_rtc::ReturnCode_t on_shutdown(omg_rtc::ExecutionContextHandle_t exec_context) override;
	virtual omg_rtc::ReturnCode_t on_activated(omg_rtc::ExecutionContextHandle_t exec_context) override;
	virtual omg_rtc::ReturnCode_t on_deactivated(omg_rtc::ExecutionContextHandle_t exec_context) override;
	virtual omg_rtc::ReturnCode_t on_aborting(omg_rtc::ExecutionContextHandle_t exec_context) override;
	virtual omg_rtc::ReturnCode_t on_error(omg_rtc::ExecutionContextHandle_t exec_context) override;
	virtual omg_rtc::ReturnCode_t on_reset(omg_rtc::ExecutionContextHandle_t exec_context) override;
